...
export const splat = str => c => split(str).map(cat(c)).join();
...
export const splAdd = str => c => appendUnion(splat(str)(c))(str);
...
export const crossW = s0 => s1 => split(s1).reduce(splAddB, cat(s1)(s0));
